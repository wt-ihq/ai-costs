    ...
    <ResponsiveContainer width="100%" height={height}>
      <BarChart data={data} margin={{ left: 8, right: 8, top: 8 }}>
        {/* Auto-thin ticks based on available width: shows every label when
            there's room, drops some on narrow screens so they never overlap.
            minTickGap is the min px between rendered ticks. */}
        <XAxis dataKey="label" tickLine={false} axisLine={false} interval="preserveStartEnd" minTickGap={24} {...AXIS} />
